    ...
    return (
      ...
      >
        ...
        <motion.div
          ...
          className="relative z-10 bg-slate-900/80 border border-cyan-500/30 p-6 sm:p-10 rounded-3xl w-[95%] max-w-[420px] shadow-2xl backdrop-blur-xl"
	    >
...
>
  ...
  setSidebarOpen(false);
	...
	SentinelX Dashboard
        ...
        {/* STATS */}
      className="grid grid-cols-1 sm:grid-cols-2 2xl:grid-cols-4 gap-4 sm:gap-6 mb-10"      
